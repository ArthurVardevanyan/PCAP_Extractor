...
Spath = ""
folder = "TShark" # This is the subfolder where the generated pcap files are stored (Must Already Exist)
#Spath = "/ROOTTOYOURFOLDER" #Server Path, ONLY UNCOMMENT IN PRODUCTION
...
while True:
    ...
    data = TShark_data(Spath, files, folder) #Function: Cleans up the PCAP file into a usable format.
